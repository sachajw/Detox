...
class ReactNativeIdlingResources constructor(
    ...
    private var asyncStorageIdlingResource: AsyncStorageIdlingResourcez? = null
    private var legacyAsyncStorageIdlingResource: AsyncStorageIdlingResourcez? = null
...
//                registerLooperAsIdlingResource(mqUIBackground)
    ...
    private fun setupAsyncStorageIdlingResource() {
        asyncStorageIdlingResource = AsyncStorageIdlingResourcez.createIfNeeded(reactContext, false)?.also {
            IdlingRegistry.getInstance().register(it)
        }

        legacyAsyncStorageIdlingResource = AsyncStorageIdlingResourcez.createIfNeeded(reactContext, true)?.also {
            IdlingRegistry.getInstance().register(it)
        }
    }
